...
model_ner = spacy.load('data/card/output/model-best/')
...
def getPredictions(image):
    ...
    entities = dict(NAME=[], ADDRESS=[], PROFESSION=[], PHONE=[], EMAIL=[], WEB=[])
    previous = 'O'
        ...
        if bio_tag in ('B', 'I'):
            ...
            if previous != label_tag:
                ...
                if bio_tag == "B":
                    ...
                    if label_tag in ("NAME", 'ORG', 'PROFESSION'):
